        ...
        <div class="w-full bg-stone-900 flex block justify-center align-center">
            <div class="w-full pt-14">
                <div class="float-left">
                    ...
                    <p class="text-stone-500 font-semibold text-xl pt-2">"Software Engineer based out of Honolulu, HI"</p>
                </div>
                <div class="flex pt-6 float-right gap-x-4 text-stone-700">
                    {items}
                </div>
            </div>
        </div>
